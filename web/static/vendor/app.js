...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"App.Msg":{"args":[],"tags":{"SendMessage":[],"NoMessage":[],"SetNewMessage":["String"],"MessageNoName":[],"ShowLeftMessage":["String"],"ReceiveChatMessage":["Json.Encode.Value"],"SetNewName":["String"],"PhoenixMsg":["Phoenix.Socket.Msg App.Msg"],"ShowJoinedMessage":["String"],"NoOp":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
